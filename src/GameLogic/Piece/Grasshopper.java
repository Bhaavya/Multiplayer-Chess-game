...
/**Defines behaviour of GrassHopper
 *
 */
public class Grasshopper extends Piece {
    public Grasshopper(String color, Cell cell) {
        super(color, cell);
    }
    ...
    public ArrayList<Cell> getValidLeftDownMoves(Board board, int startPos,int leftOrDown) {
        return (MultiCellMove.getValidLeftDownMoves(board, startPos, leftOrDown, this,true));
    }
    ...
    public ArrayList<Cell> getValidUpRightMoves(Board board, int startPos,int upOrRight) {
        return (MultiCellMove.getValidUpRightMoves(board, startPos, upOrRight,this,true));
    }
    ...
    public ArrayList<Cell> getValidLeftDownDiagMoves(Board board, int startRank, int startFile) {
        return (MultiCellMove.getValidLeftDownDiagMoves(board, startRank, startFile, this,true));
    }
    ...
    public ArrayList<Cell> getValidUpRightDiagMoves(Board board, int startRank, int startFile) {
        return (MultiCellMove.getValidUpRightDiagMoves(board, startRank, startFile, this,true));
    }
    ...
    public ArrayList<Cell> getValidUpLeftDiagMoves(Board board, int startRank, int startFile) {
        return (MultiCellMove.getValidUpLeftDiagMoves(board, startRank, startFile, this,true));
    }
    ...
    public ArrayList<Cell> getValidDownRightDiagMoves(Board board, int startRank, int startFile) {
        return (MultiCellMove.getValidDownRightDiagMoves(board, startRank, startFile, this,true));
    }
    @Override
    /*
    Grasshopper moves similar to queen but there must be another piece on the path
     */
