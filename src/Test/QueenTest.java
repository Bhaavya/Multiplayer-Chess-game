...
public class QueenTest {
    ...
    public void testMoveToEmptySpot() {
        ...
        cells[1][3].removePiece();
        //try to move forward
        Cell sourceCell = cells[0][3];
        Cell destinationCell = cells[3][3];
    ...
    public void invalidMovesTest() {
        ...
        //try to leap
        Cell sourceCell=cells[0][3];
        Cell destinationCell=cells[1][3];
    ...
    public void testCapture() {
        ...
        board.setBoard(p1, p2);
        Cell cells[][] = board.getCells();
        Cell sourceCell= cells[6][0];
        Piece piece = sourceCell.getPieceAtCell();
        cells[1][2].removePiece();
        for(int i=5;i>2;i--) {
            piece.moveTo(board, cells[i][0], p2, piece);
            sourceCell= cells[i][0];
            piece = sourceCell.getPieceAtCell();
        }
        //capture black pawn
        Cell cellUnderAttack = cells[3][0];
        testMoveCapture(board, p1, cells[0][3], cellUnderAttack);
    }
