 ...
 */
    ...
    public Piece.pieceType[][] formConfigArray(){
        ...
        configArray[1][0] =Piece.pieceType.WHITE_EMPRESS;
    ...
    @Test
    /**
     * test moving to a valid location like knight and rook
     */
    ...
    public void testCapture() {
        ...
        board.setBoard(p1, p2);
        Cell cells[][] = board.getCells();
        //capture black pawn by moving up
    ...
    public void testMoveCapture(SquareBoard board, Player player,  Cell sourceCell, Cell destinationCell) {
        ...
        assertEquals(true,attackingPiece.moveTo(board, destinationCell, player, attackingPiece));
